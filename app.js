...
app.get('/', function (req, res) {
  res.send('<h1 style="color:DodgerBlue; border:2px solid Violet; font-size:200%; background-image:"https://unsplash.com/photos/jZxairpkhho";>Welcome to the default page!  <br> <br>' +
